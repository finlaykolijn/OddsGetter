        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, client.getLeagueOdds('soccer_spain_la_liga')];
                case 2:
                    odds = _a.sent();
                    console.log("Found ".concat(odds.length, " La Liga games with odds."));
                    if (odds.length > 0) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error fetching La Liga odds:', error_1);
                    return [3 /*break*/, 4];
